        ...
        <CardActions>
          ...
          >
            <ButtonGroup className="card-group__button" size='large' color='secondary'>
              <Button className="card-box__button" size='medium' onClick={() => handleClick('AGAIN')}>
              Again
              </Button>
              <Button className="card-box__button" size='medium' onClick={() => handleClick('HARD')}>
              Hard
              </Button>
              <Button className="card-box__button" size='medium' onClick={() => handleClick('GOOD')}>
              Good
              </Button>
              <Button className="card-box__button" size='medium' onClick={() => handleClick('EASY')}>
              Easy
              </Button>
            </ButtonGroup>
          </Grid>
